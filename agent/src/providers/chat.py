...
class ChatLLM:
    ...
    def __init__(self, model_name: Optional[str] = None, llm_settings: Mapping[str, str] | None = None) -> None:
        """Initialize ChatLLM.
        ...
        self._llm = build_llm(model_name=model_name, settings=llm_settings)
